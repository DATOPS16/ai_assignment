#the code below are content of app6clas.py
...
# Load the OCR model
MN_load_model = load_model("MN_model_6class.h5")
...
def app():
    ...
    if image_file is not None:
        ...
        if result == 0:
            ...
            st.write("Predicted text: Seven")
        elif result == 8:
            st.write("Predicted text: Eight")
        elif result == 9:
            st.write("Predicted text: Nine")
        else:
